...
<ul class="main-tabs" style="display: flex; justify-content: center; border: double; background-image:images\배경.png ;">
  <li>
    <button class="round-button" onclick="location.href='${cpath}/login.do'" data-translate-value="0" style="background-color: #EEddd6;">
      <span class="avatar">
  ...
  <li>
    <button class="round-button gallery active" onclick="location.href='${cpath}/joina.do'" style="--round-button-active-color: #2962ff" data-translate-value="100%" data-color="blue" >
  ...
  <li>
    <button class="round-button" onclick="location.href='${cpath}/main.do'"  style="--round-button-active-color: #00c853" data-translate-value="200%" data-color="green">
         <a href=""></a>
  ...
  <li>
    <button class="round-button"  onclick="location.href='${cpath}/detail.do'" style="--round-button-active-color: #aa00ff" data-translate-value="300%" data-color="purple">
         <a href=""></a>
  ...
  <li>
    <button class="round-button" onclick="location.href='${cpath}/mypage.do'" style="--round-button-active-color: #ff6d00" data-translate-value="400%" data-color="orange">
        <a href=""></a>
